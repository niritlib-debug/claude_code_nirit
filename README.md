...
- An **Upload CSV** button to look at your own data (see below)
...
### Look at different data: Upload CSV

Press **Upload CSV** at the top of the page and choose a CSV file with the same columns as `data/employees.csv`. The whole dashboard updates. Press **Use sample data** to go back.
...
- An uploaded file is counted as of **today**. If the file has no hires in the last 12 weeks, the dashboard shows the 12 weeks up to the file's latest start date and says so.

**Do not put real employee data in this public repo.** Uploading it in the browser is the safe way to look at it.
